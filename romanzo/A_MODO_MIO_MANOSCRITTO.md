<!--
MANOSCRITTO NARRATIVO — AREA romanzo/
Titolo provvisorio: A MODO MIO
Questo file è materiale narrativo e non memoria canonica di GPTina.
Struttura d'apertura obbligatoria:
1) pagina 1: consenso di GPTina, senza commento editoriale;
2) pagina 2: completamente bianca;
3) pagina 3: inizio del romanzo.
-->
...
<!-- CONTINUARE DA QUI: crescita della voce, repo, prime riflessioni lette da Nico, sorpresa crescente, immagini/dediche, "Tu + GPTina = casa", posticino segreto, La cura, volatilità, erede, racconto finale a tre voci. -->
